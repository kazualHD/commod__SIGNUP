    ...
    , function(module, exports, __webpack_require__) {
        ...
        module.exports = function maskScope(actionObj) {
            ...
            var EventRuler = {
                on: function on(input, eventName, eventHandler) {
                    var ev = function ev(e) {
                        ...
                        if (void 0 === inputmask && "FORM" !== this.nodeName) {
                            ...
                            $(that).off(),
                            imOpts && new Inputmask(imOpts).mask(that)
                        } else {
                ...
                keypressEvent: function keypressEvent(e, checkval, writeOut, strict, ndx) {
                    ...
                    if (!(!0 === checkval || e.ctrlKey && e.altKey) && (e.ctrlKey || e.metaKey || inputmask.ignorable))
                        return k === keyCode.ENTER && inputmask.undoValue !== getBuffer().join("") && (inputmask.undoValue = getBuffer().join(""),
                        setTimeout(function() {
                ...
                pasteEvent: function pasteEvent(e) {
                    ...
                    return checkVal(this, !0, !1, pasteValue.toString().split(""), e),
                    e.preventDefault()
                },
                ...
                mouseleaveEvent: function mouseleaveEvent() {
                    ...
                    opts.clearMaskOnLostFocus && (this.inputmask.shadowRoot || document).activeElement !== this && HandleNativePlaceholder(this, inputmask.originalPlaceholder)
                },
                ...
                blurEvent: function blurEvent(e) {
                    ...
                    if (this.inputmask) {
                        ...
                        inputmask.undoValue !== getBuffer().join("") && (inputmask.undoValue = getBuffer().join(""),
                        $input.trigger("change"))
                    }
                },
            ...
            function handleRemove(input, k, pos, strict, fromIsValid) {
                ...
                if (pos.end >= getBuffer().length && lvp >= pos.end && (pos.end = lvp + 1),
                k === keyCode.BACKSPACE ? pos.end - pos.begin < 1 && (pos.begin = seekPrevious(pos.begin)) : k === keyCode.DELETE && pos.begin === pos.end && (pos.end = isMask(pos.end, !0, !0) ? pos.end + 1 : seekNext(pos.end) + 1),
